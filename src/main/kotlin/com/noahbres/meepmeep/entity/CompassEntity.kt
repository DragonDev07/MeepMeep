...
class CompassEntity(
    ...
    override fun mouseMoved(me: MouseEvent?) {
        if (me!!.x > pos.toScreenCoord().x - width.scaleInToPixel() / 2
            ...
            animationController.anim(colorScheme.AXIS_HOVER_OPACITY, 200.0, com.noahbres.meepmeep.anim.Ease.EASE_OUT_CUBIC)
        } else {
            animationController.anim(colorScheme.AXIS_NORMAL_OPACITY, 200.0, com.noahbres.meepmeep.anim.Ease.EASE_OUT_CUBIC)
        }
    }
