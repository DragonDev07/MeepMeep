...
import dev.furthestdrop.meepmeep.anim.AnimationController
import dev.furthestdrop.meepmeep.anim.Ease
import dev.furthestdrop.meepmeep.colorscheme.ColorScheme
import dev.furthestdrop.meepmeep.scaleInToPixel
...
//            currentOpacity = hoverOpacity
            animationController.anim(colorScheme.AXIS_HOVER_OPACITY, 200.0, dev.furthestdrop.meepmeep.anim.Ease.EASE_OUT_CUBIC)
        } else {
//            currentOpacity = normalOpacity
            animationController.anim(colorScheme.AXIS_NORMAL_OPACITY, 200.0, dev.furthestdrop.meepmeep.anim.Ease.EASE_OUT_CUBIC)
        }
    }
