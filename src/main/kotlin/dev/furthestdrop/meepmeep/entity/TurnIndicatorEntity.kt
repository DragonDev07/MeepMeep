...
import dev.furthestdrop.meepmeep.toDegrees
...
class TurnIndicatorEntity(
    ...
    override fun render(gfx: Graphics2D, canvasWidth: Int, canvasHeight: Int) {
        ...
        gfx.stroke = BasicStroke(
            TURN_STROKE_WIDTH.scaleInToPixel().toFloat(),
        ...
        var arrow1Rotated =
            endAngle - 90.0.toRadians() + TURN_ARROW_ANGLE + TURN_ARROW_ANGLE_ADJUSTMENT
        ...
        val arrowEndVec2 =
            (pos + arrowPointVec) + Vector2d(TURN_ARROW_LENGTH, 0.0).rotated(arrow2Rotated)
